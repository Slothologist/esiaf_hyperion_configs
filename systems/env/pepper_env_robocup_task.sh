...
export SPLITTER_CPP_CONFIG="${prefix}/share/esiaf_ros/config/pepper_robot_splitter.cfg"

export AUDIO_SEGMENTER_CONFIG="${prefix}/share/audio_segmenter/config/pepper_robot.cfg"
export POCKETSPHINX_CONFIG="${prefix}/share/esiaf_pocketsphinx/config/robocup_task.yaml"
